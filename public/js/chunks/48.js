  ...
  methods: {
    ...
    validationForm: function validationForm() {
      ...
      this.$refs.createsale.validate().then(function (success) {
        if (success) {
          _libs_axios__WEBPACK_IMPORTED_MODULE_3__["default"].post('api/v1/shop/sale', _this3.form).then(function (response) {
            ...
            _this3.$bvToast.toast('sale created successfully.', {
              title: 'Success',
              variant: 'success',
              solid: true
            });
