...
/***/ "./frontend/src/navigation/vertical/admin-nav.js":
/*!*******************************************************!*\
  !*** ./frontend/src/navigation/vertical/admin-nav.js ***!
  \*******************************************************/
/*! exports provided: default */
...
/* harmony import */ var _navigation_vertical_admin_nav__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/navigation/vertical/admin-nav */ "./frontend/src/navigation/vertical/admin-nav.js");
/* harmony import */ var vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-perfect-scrollbar */ "./frontend/node_modules/vue-perfect-scrollbar/dist/index.js");
/* harmony import */ var vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(vue_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  setup: function setup(props) {
    ...
    return {
      ...
      adminNavMenuItems: _navigation_vertical_admin_nav__WEBPACK_IMPORTED_MODULE_1__["default"],
...
/* harmony import */ var _libs_axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/libs/axios */ "./frontend/src/libs/axios.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      ...
      // Remove userData from localStorage
      // ? You just removed token from localStorage. If you like, you can also make API call to backend to blacklist used token
      _libs_axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('api/v1/shop/logout').then(function (response) {
        if (response.data.success) {
          localStorage.removeItem('userAccessToken'); // Remove userData from localStorage

          localStorage.removeItem('userData'); // Redirect to login page
    ...
    adminLogout: function adminLogout() {
      ...
      // Remove userData from localStorage
      // ? You just removed token from localStorage. If you like, you can also make API call to backend to blacklist used token
      _libs_axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('api/v1/admin/logout').then(function (response) {
        if (response.data.success) {
          localStorage.removeItem('userAccessToken'); // Remove userData from localStorage

          localStorage.removeItem('adminData'); // Redirect to login page
    ...
    getUserInfo: function getUserInfo() {
      ...
      _libs_axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('api/v1/shop/my-info').then(function (response) {
                        ...
                        return [
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _c("span", { staticClass: "user-status" }, [
                                _vm._v(_vm._s(_vm.user.shop.name))
                              ])
                            ]
                          ),
                          _vm._v(" "),
